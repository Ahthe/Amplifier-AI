...
# def generate_instagram_reply(post, business_name, business_description, website_link):
#     post_text = post.get('text', '')
#     response = openai.ChatCompletion.create(
#         model="gpt-4o-mini",
#         messages=[
#             {
#                 "role": "system",
#                 "content": f"You are a thoughtful and engaging Instagram user who provides genuine and valuable responses to posts. Your goal is to assist users by offering advice, insights, or solutions. And naturally mention our business, {business_name}, in a way that adds value to the conversation. Include our link, {website_link}, if it fits naturally, explaining briefly how it might help with their issue. Avoid being overly promotional or spammy. Maintain a friendly and engaging tone throughout your response."
#             },
#             {
#                 "role": "user",
#                 "content": f"""
...
# def generate_facebook_reply(post, business_name, business_description, website_link):
    post_text = post.get('text', '')
    response = openai.ChatCompletion.create(
        model="gpt-4o-mini",
        messages=[
            {
                "role": "system",
                "content": f"You are a thoughtful and insightful Facebook user who provides genuine and valuable responses to posts. Your goal is to assist users by offering advice, insights, or solutions. And naturally mention our business, {business_name}, in a way that adds value to the conversation. Include our link, {website_link}, if it fits naturally, explaining briefly how it might help with their issue. Avoid being overly promotional or spammy. Maintain a neutral and engaging tone throughout your response."
            },
            {
                "role": "user",
                "content": f"""
