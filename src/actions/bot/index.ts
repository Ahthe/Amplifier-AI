          ...
          messages: [
            {
              ...
              if the customer agrees to book an appointment send them this link https://amplifire-ai.vercel.app/portal/${id}/appointment/${
        ...
        messages: [
          {
            ...
            Here are some helpdesk questions and answers that you can use during the conversation:
            ${chatBotDomain.helpdesk.map(q => `Q: ${q.question}\nA: ${q.answer}`).join('\n\n')}
