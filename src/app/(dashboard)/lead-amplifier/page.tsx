  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6">
      <div className="max-w mx-auto bg-white rounded-lg shadow p-6">
        ...
        {/* {leads.instagram_leads.length > 0 && (
          <div className="mt-6">
            <h2 className="text-xl font-bold">Instagram Leads</h2>
            <ul className="list-disc pl-6">
              {leads.instagram_leads.map((lead, index) => (
                <li key={index} className="mt-2">
                  <p>
                    <strong>Post:</strong> {lead.text}
                  </p>
                  <p>
                    <strong>User:</strong> {lead.user}
                  </p>
        ...
        {/* {leads.facebook_leads.length > 0 && (
          <div className="mt-6">
            <h2 className="text-xl font-bold">Facebook Leads</h2>
            <ul className="list-disc pl-6">
              {leads.facebook_leads.map((lead, index) => (
                <li key={index} className="mt-2">
                  <p>
                    <strong>Post:</strong> {lead.text}
                  </p>
